...
time lineage extraction runs, via `reticulate::py_require()` — there is
no setup step. See `vignette("python-integration")` if you manage your
...
- converts your pipeline to SQL with `dbplyr::sql_render()`
