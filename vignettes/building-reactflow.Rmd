...
### Option 1: Using R (Recommended for Users)
...
This method works from anywhere and automatically finds the correct package directory.

### Option 2: Using the build script (For Developers)
