...
- The [lineage that travels with the data](https://tgerke.github.io/dplyneage/articles/ducklake-versioned-lineage.html) article stores each layer's lineage on its ducklake commit, a one-line addition to `publish()`, so the derivation as of any snapshot comes back from the lake without the store
