...
- **Tier 4** (#14–#16): strategic bets. Label and description
  ...
  elsewhere only Spark has one. Targets integration (#16) shipped in
  0.3.0.9000 as a site article rather than an API: a target’s value
  carries the lazy query that built its layer,
